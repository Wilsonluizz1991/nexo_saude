<x-layouts.app title="Esqueci minha senha | Nexo Saude">
        ...
        <section class="nexo-login-card">
            ...
            <div class="nexo-login-form-area">
                <div class="nexo-login-form-header">
                    ...
                    <p>
                        Por seguranca, a resposta sera a mesma mesmo que o e-mail nao esteja cadastrado.
                    </p>
                </div>
    ...
    <style>
        ...
        .nexo-login-footer a { color: #2F80ED; text-decoration: none; font-weight: 850; }
